...
/**
 * Thread que lida com a lógica de um único cliente conectado. Baseado no uso
 * padrão de java.lang.Thread.
 */
public class ClientHandler extends Thread {
    ...
    /**
     * Envia uma atualização (segura) para TODOS os clientes conectados, exceto
     * para este (que é o registrador).
     */
