...
public class CryptoUtils {
  ...
  /**
   * Cifra uma mensagem (String) usando AES/CBC/PKCS5Padding.
   * Requer a chave (bytes) e o VI. Retorna String em Base64.
   */
  ...
  /**
   * Decifra uma mensagem (String Base64) usando AES/CBC/PKCS5Padding.
   * Requer a chave (bytes) e o VI. Retorna a String original.
   */
