...
public class ServiceClient {
    ...
    public static void main(String[] args) {
        ...
        try (
                Socket dirSocket = new Socket(DIRECTORY_ADDRESS, DIRECTORY_PORT); PrintWriter dirWriter = new PrintWriter(dirSocket.getOutputStream(), true, StandardCharsets.UTF_8); BufferedReader dirReader = new BufferedReader(
                        new InputStreamReader(dirSocket.getInputStream(), StandardCharsets.UTF_8)); Scanner scanner = new Scanner(System.in)) {
    ...
    private static String executeRemoteCalculation(String serverAddress, String calcMessage) {
        try {
            ...
            try (Socket calcSocket = new Socket(ip, port); PrintWriter calcWriter = new PrintWriter(calcSocket.getOutputStream(), true, StandardCharsets.UTF_8); BufferedReader calcReader = new BufferedReader(
