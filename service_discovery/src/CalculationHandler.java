...
/**
 * Thread que lida com um único pedido de cálculo no Servidor de Calculadora.
...
public class CalculationHandler extends Thread {
    ...
    public void run() {
        try (
                BufferedReader reader = new BufferedReader(
                        new InputStreamReader(socket.getInputStream(), StandardCharsets.UTF_8)); PrintWriter writer = new PrintWriter(socket.getOutputStream(), true, StandardCharsets.UTF_8)) {
    ...
    /**
     * Realiza a operação de cálculo. Formato esperado: "soma 5 10"
     */
