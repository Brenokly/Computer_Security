...
/**
 * Classe para armazenar as chaves secretas compartilhadas entre o servidor e os
 * clientes. * É fundamental que o cliente e o servidor tenham exatamente as
 * mesmas chaves para a comunicação funcionar.
 */
public class SharedConfig {
    ...
    private static final String HMAC_KEY_RUIM_STRING = "esta-e-uma-chave-totalmente-errada";
    ...
    public static byte[] getHmacKeyRuim() {
        return HMAC_KEY_RUIM_STRING.getBytes(StandardCharsets.UTF_8);
    }
}
